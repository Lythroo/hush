...
public final class HushSoundInstance implements TickableSoundInstance {
	...
	// NeoForge replaces vanilla's id-based audio-stream lookup with this Sound-based hook; delegate
	// it so the wrapped instance keeps full control over how its samples are sourced.
	@Override
